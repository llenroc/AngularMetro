    ...
    vm.list = [
      ...
      //ui效果
      {
          url: "", title: "AngularJS Features", icon: "icon-settings", child: [
               { url: "uibootstrap", title: " UI Bootstrap", icon: "icon-puzzle" },
               { url: "fileupload", title: " File Upload", icon: "icon-paper-clip" },
               { url: "uiselect", title: " UI Select", icon: "icon-check" },
          ]
      },
        //ui效果
      {
          url: "", title: "jQuery Plugins", icon: "icon-wrench", child: [
               { url: "formtools", title: " Form Tools ", icon: "icon-puzzle" },
               { url: "pickers", title: " Date & Time Pickers ", icon: "icon-calendar" },
               { url: "dropdowns", title: " Custom Dropdowns ", icon: "icon-refresh" },
               { url: "tree", title: " Tree View ", icon: "icon-share" },
               { url: "datatablesmanaged", title: "Datatables", icon: "icon-briefcase"},
          ]
      },
         //个人信息
      { url: "profile.dashboard", title: "User Profile", icon: "icon-user" },
      //todo
      { url: "todo", title: "Task & Todo", icon: "icon-check" },
      //blank
      { url: "blank", title: "Blank Page", icon: "icon-refresh" },
    ];
